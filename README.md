...
It uses a simple desktop app to check your email every 3 seconds and check for OTP codes. pressing the key will paste it. ~~i will probably reprogram this later to play geometry dash.~~
